...
public class Usuario {
    ...
    @Size(message = "El tipo de documento debe ser entre 2 y 10 caracteres", min = 3, max = 20)
    private String tipoDocumento;

    @NotBlank(message = "Debe ingresar el documento de identificacion del usuario")
    @Size(message = "El documento de identificacion debe ser entre 6 y 14 caracteres", min = 3, max = 14)
